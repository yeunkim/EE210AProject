...
X_train_jac = data.jac_train_data_matrix
X_test_jac = data.jac_test_data_matrix
...
number_of_classes = 2
Y_train = np_utils.to_categorical(Y_train[0:196], number_of_classes)
